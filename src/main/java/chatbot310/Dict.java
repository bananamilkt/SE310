...
public class Dict{
    ...
    public Dict() throws JWNLException, FileNotFoundException, InterruptedException{        
    		String dict = getClass().getClassLoader().getResource("/dict").getFile();
    		...
    		//InputStream stream = this.getClass().getClassLoader().getResourceAsStream("/properties.xml");
    ...
    private boolean isConjunction(String word){
        this.conjunctionFilePath = getClass().getClassLoader().getResourceAsStream("/additionalDict/conjunctions.txt");
    ...
    private boolean isHFVerb(String word){
        this.highFreqVerbFilePath = getClass().getClassLoader().getResourceAsStream("/additionalDict/highFrequentVerb.txt");
    ...
    private boolean isPronoun(String word){
        this.pronounFilePath = getClass().getClassLoader().getResourceAsStream("/additionalDict/pronouns.txt");
    ...
    private String checkInAddDict(String word) throws FileNotFoundException{
        this.highFreqWordFilePath = getClass().getClassLoader().getResourceAsStream("/additionalDict/highFrequentWords.txt");
        int maxMatch=0;
